(() => {
  ...
  var init_helpers3 = __esm({
    "node_modules/@supabase/gotrue-js/dist/module/lib/helpers.js"() {
      ...
      setItemAsync = (storage, key, data) => __async(void 0, null, function* () {
        yield storage.setItem(key, JSON.stringify(data));
      });
      getItemAsync = (storage, key) => __async(void 0, null, function* () {
      ...
      removeItemAsync = (storage, key) => __async(void 0, null, function* () {
