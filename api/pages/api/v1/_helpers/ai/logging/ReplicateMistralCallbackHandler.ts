...
import { PLATFORM_UNIT_TYPES, type Platforms } from "../constants";

export class ReplicateMistralCallbackHandler extends BaseCallbackHandler {
  name = "ReplicateMistralCallbackHandler";
  input: string;
  ...
  async handleLLMEnd(
    ...
    await logModelRun({
      ...
      // @ts-ignore
      output: JSON.stringify(output.generations[0][0].text),
    });
    this.input = "";
    this.requestUuid = "";
    this.startTimestamp = undefined;
